...
from cl.tradeentry.readers.number_reader_key import NumberReaderKey


@dataclass(slots=True, kw_only=True)
class NumberReader(NumberReaderKey, EntryReaderMixin[NumberEntry], RecordMixin[NumberReaderKey], ABC):
